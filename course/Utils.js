var Utils = {
  ...
  //     sljQ.get(filePath, function (data) {
  //         callback(data, options);
  //     });
  // },
  ajaxCommunication: function (sendData, sendURL, callBack, options) {
    console.log("sendData=", sendData, "sendURL=", sendURL);
    sljQ.ajax({
      type: "POST",
      url: sendURL,
      async: true,
      headers: {
        AccessCode: sendData.AccessCode,
      },
      data: sendData,
      dataType: "jsonp",
      crossDomain: true,
  ...
  showAjLoader: function () {
    console.log("Showing...");
    sljQ("div#ajLoadDialog").addClass("aj-loader-section-top");
    sljQ("div#ajLoadDialog").removeClass("aj-hide");
  },
  hideAjLoader: function () {
    console.log("Hiding...");
    sljQ("div#ajLoadDialog").removeClass("aj-loader-section-top");
    sljQ("div#ajLoadDialog").addClass("aj-hide");
  },
